...
(display (if (equal? (filter-range '(5 105 2) 100 200) '(105)) "MY1 SUCCESS" "MY1 FAILURE"))(newline)
(display (if (equal? (filter-range '(1 2 3 4) 3 5) '(3 4)) "MY SUCCESS" "MY FAILURE"))(newline)
